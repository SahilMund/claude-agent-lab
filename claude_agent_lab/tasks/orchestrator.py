...
from claude_agent_lab.tasks.task_store import SQLiteTaskStore
from claude_agent_lab.tasks.executor import run_subtask_agent
from claude_agent_lab.tasks.planner import create_plan
from claude_agent_lab.tasks.approval import present_plan_for_approval
from claude_agent_lab.tasks.recovery import RecoveryManager
...
async def handle_plan_command(goal: str) -> None:
    ...
    """
    db_path = config.get("tasks", {}).get("db_path", ".agent_lab/tasks.db")
